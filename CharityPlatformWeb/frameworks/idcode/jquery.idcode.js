...
(function ($) {
    ...
    function _setCodeStyle(eid, codeType, codeLength) {
        ...
        var htmlCode = ''
        if (!settings.inputID) {
            htmlCode = '<input id="ehong-code-input" tabindex="3" class="form-control" type="text" style="width:50%;" maxlength="4" />';
        }
    ...
    function _setStyle(codeObj) {
        ...
        for (var i = 0; i < codeObj.length; i++) {
            ...
            fnCodeObj.push('<font color="' + col[charIndex] + '" style="margin-top:10px;">' + codeObj.charAt(i) + '</font>');
        }

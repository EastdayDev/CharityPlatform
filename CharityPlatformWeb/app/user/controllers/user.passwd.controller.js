angular.module('userModule').controller('UserPwdController',
['$scope', '_user', '_app', '$state', '$window', 'epModal', 
function ($scope, _user, _app, $state, $window, epModal) {  

	$scope._user = _user.user;
	$scope.user = {C_NewPwd:'12345678', C_ConfirmPwd:'12345678', C_OldPwd:'123'};

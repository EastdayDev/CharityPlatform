...
angular.module('commonModule').constant('apiPrefix',
  'http://localhost:4972/api');
...
angular.module('commonModule').factory('_http', ['$http', '$q', '$rootScope',
  '_cookie', 'apiPrefix',
...
angular.module('commonModule').factory('_tool', [function() {
  var service = {};

  service.randomBy = function(under, over) {
